...
import styles from "./KidzaHeader3.module.css";

export function KidzaHeader3({ data }: ThemeProps) {
                ...
                <div className={styles.navigationInner}>
                    ...
                    <div className={styles.actions}>
                        ...
                        <button
                            ...
                            aria-controls="kidza3-public-navigation"
                            onClick={() => {
