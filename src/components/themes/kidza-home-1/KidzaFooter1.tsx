...
import styles from "./KidzaFooter1.module.css";
...
export function KidzaFooter1({ data }: ThemeProps) {
        ...
        >
            <div className={styles.inner}>
                <div className={styles.brandColumn}>
                    <Link href={schoolHomeUrl} className={styles.brand}>
                        {data.school.logoUrl ? (
                            ...
                            <img src={data.school.logoUrl} alt={`${data.school.name} logo`} className={styles.logo} />
                        ) : (
                ...
                <div className={styles.contactColumn}>
                    ...
                    <a href={`tel:${data.website.contact.phone}`}>{data.website.contact.phone}</a>
                    <a href={`mailto:${data.website.contact.email}`}>{data.website.contact.email}</a>
                </div>
            </div>

            <div className={styles.bottomBar}>
                <p>
                    &copy; {new Date().getFullYear()} {data.school.name}. All rights reserved.
                </p>
