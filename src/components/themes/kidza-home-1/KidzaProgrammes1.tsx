...
import styles from "./KidzaProgrammes1.module.css";

export function KidzaProgrammes1({ data }: ThemeProps) {
                        ...
                        <li key={programme.id} className={styles.card}>
                            <div className={styles.imageWrap}>
                                {programme.imageUrl ? (
                                    ...
                                    <img src={programme.imageUrl} alt={programme.name} className={styles.image} />
                                ) : (
