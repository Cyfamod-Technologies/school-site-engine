...
import styles from "./KidzaHighlights1.module.css";

export function KidzaHighlights1({ data }: ThemeProps) {
                    ...
                    {highlights.map((highlight) => (
                        <li key={highlight.id} className={styles.card}>
                            {highlight.iconUrl ? (
                                ...
                                <img src={highlight.iconUrl} alt="" aria-hidden="true" className={styles.icon} />
                            ) : (
